            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> Ulica
                                <form:input path="street" id="street" type="text" name="adress"/>
                            </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Miasto <form:input path="city" id="city" type="text"/>
                            </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label>
                                Kod pocztowy <form:input path="zipCode" name="zipCode" type="text"/>
                            </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label>
                                Numer telefonu <form:input path="phoneNo" name="phoneNo" type="phone"/>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            ...
                            <ul>
                                ...
                                <li id="summary-phoneNo">123 456 789</li>
                            </ul>
                        </div>
